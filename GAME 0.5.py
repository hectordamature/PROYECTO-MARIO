...
ene2= c.create_image(900, 105, image=eneimg, anchor=NW)
c.place(x= 0,y=0)
estado=2
esn=True
ya=False
...
def enem():
    global m, ene, en, en1, ene2, n, esn, lives
    if(c.coords(mario)[0]> c.coords(ene)[0]-25 and c.coords(mario)[0]< c.coords(ene)[0]+25 and c.coords(mario)[1]> c.coords(ene)[1] and c.coords(mario)[1]< c.coords(ene)[1]+100):
        m= 2
        esn=False
        en=c.coords(ene)[0]
        en1=c.coords(ene)[1]
    ...
    if(c.coords(mario)[0]> c.coords(ene)[0]-25 and c.coords(mario)[0]< c.coords(ene)[0]+25 and c.coords(mario)[1]> c.coords(ene)[1]-30 and c.coords(mario)[1]< c.coords(ene)[1]+30 and esn==True):
        c.coords(mario, 500, 665)
        lives-=1
        if(lives==0):
            c.coords(mario, -100, -100)
    elif(c.coords(mario)[0]> c.coords(ene)[0]-25 and c.coords(mario)[0]< c.coords(ene)[0]+25 and c.coords(mario)[1]> c.coords(ene)[1]-30 and c.coords(mario)[1]< c.coords(ene)[1]+30 and esn==False):
         esn=True
         c.delete(ene)
    ...
    if(n==0):
        ...
        ec1=c.coords(ene2)[1]
        c.delete(ene2)
        ene2= c.create_image(ec, ec1, image=eneimg, anchor=NW)
        c.move(ene2,-3,0)
        ventana.update()
        ventana.after(1)
        n=1
        ...
        ec1=c.coords(ene2)[1]
        c.delete(ene2)
        ene2= c.create_image(ec, ec1, image=eneimg2, anchor=NW)
        c.move(ene2,-3,0)
        ventana.update()
        ventana.after(1)
        n=0
...
##            c.coords(mario, -100, -100)
    ...
    #muerte 2        
    elif(c.coords(mario)[0]> c.coords(ene2)[0]-25 and c.coords(mario)[0]< c.coords(ene2)[0]+25 and c.coords(mario)[1]> c.coords(ene2)[1]-30 and c.coords(mario)[1]< c.coords(ene2)[1]+30):
        c.coords(mario, 500, 665)
        lives-=1
        if(lives==0):
            c.coords(mario, -100, -100)
    ...
    # mapa continuo tortuga 2
    if(c.coords(ene2)[0]>1287):
        te=c.coords(ene2)[1]
        c.coords(ene2, 220,te)
    if(c.coords(ene2)[0]<212):
        te=c.coords(ene2)[1]
        c.coords(ene2, 1283,te)
    # suelo tortuga 2
    if(c.coords(ene2)[1]>685):
        te=c.coords(ene2)[0]
        c.coords(ene2,te,685)
    # plataforma 1 tortuga 2
    elif(c.coords(ene2)[0]>912 and c.coords(ene2)[1]>492 and c.coords(ene2)[1]<603):
        te=c.coords(ene2)[0]
        c.coords(ene2,te,492)
    # caida 1 tortuga 2
    elif(c.coords(ene2)[0]<912 and c.coords(ene2)[0]>588 and c.coords(ene2)[1]==492):
        te=c.coords(ene2)[0]
        contador7=0
        while(contador7<40):
            c.move(ene2,0,10)
            ...
            time.sleep(0.0001)
            contador7+=1
    # plataforma 2 tortuga 2
    elif(c.coords(ene2)[0]<588 and c.coords(ene2)[1]>492 and c.coords(ene2)[1]<603):
        te=c.coords(ene2)[0]
        c.coords(ene2,te,492)
    # plataforma 3 tortuga 2
    elif(c.coords(ene2)[1]<410 and c.coords(ene2)[1]>298 and c.coords(ene2)[0]<347):
        te=c.coords(ene2)[0]
        c.coords(ene2,te,298)
    # caida 2 tortuga 2
    elif(c.coords(ene2)[0]>347 and c.coords(ene2)[0]<466 and c.coords(ene2)[1]==298):
        te=c.coords(ene2)[0]
        contador7=0
        while(contador7<25):
            c.move(ene2,0,10)
            ...
            time.sleep(0.0001)
            contador7+=1
    # plataforma 4 tortuga 2
    elif(c.coords(ene2)[1]<410 and c.coords(ene2)[1]>298 and c.coords(ene2)[0]>466 and c.coords(ene2)[0]<1037):
        te=c.coords(ene2)[0]
        c.coords(ene2,te,298)
    # caida 3 tortuga 2
    elif(c.coords(ene2)[0]>1037 and c.coords(ene2)[0]<1154 and c.coords(ene2)[1]==298):
        te=c.coords(ene2)[0]
        contador8=0
        while(contador8<25):
            c.move(ene2,0,10)
            ...
            time.sleep(0.0001)
            contador8+=1
    # plataforma 5 tortuga 2
    elif(c.coords(ene2)[1]<410 and c.coords(ene2)[1]>298 and c.coords(ene2)[0]>1154):
        te=c.coords(ene2)[0]
        c.coords(ene2,te,298)
    # plataforma 6 tortuga 2
    elif(c.coords(ene2)[1]<218 and c.coords(ene2)[1]>103 and c.coords(ene2)[0]<692):
        te=c.coords(ene2)[0]
        c.coords(ene2,te,105)
    # caida 4 tortuga 2
    elif(c.coords(ene2)[0]>692 and c.coords(ene2)[0]<810 and c.coords(ene2)[1]==105):
        te=c.coords(ene2)[0]
        contador9=0
        while(contador9<25):
            c.move(ene2,0,10)
            ...
            time.sleep(0.0001)
            contador9+=1
    # plataforma 7 tortuga 2
    elif(c.coords(ene2)[1]<218 and c.coords(ene2)[1]>105 and c.coords(ene2)[0]>810):
        te=c.coords(ene2)[0]
        c.coords(ene2,te,105)
